"""
HTPC remote entity with UI pages and system commands.
...
class HTCPRemote(RemoteEntity):
    """Remote entity for HTPC control with UI pages."""
    ...
    def __init__(self, device_config: HTCPConfig, device: HTCPDevice) -> None:
        ...
        pages = [
            ...
            _create_media_page(),
            _create_windows_shortcuts_page(),
            _create_system_tools_page(),
            _create_function_keys_page(),
            _create_power_system_page(device_config.wol_enabled),
        ]
...
def _create_windows_shortcuts_page() -> UiPage:
...
def _create_system_tools_page() -> UiPage:
...
def _create_power_system_page(wol_enabled: bool) -> UiPage:
